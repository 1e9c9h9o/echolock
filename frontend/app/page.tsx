      ...
      <footer className="bg-black text-cream py-16 relative border-t-4 border-blue">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col gap-4">
            <div>
              <p className="font-bold">ECHOLOCK is open-source software under AGPL-3.0 license.</p>
              <p className="mt-2 text-sm opacity-75">Contributions are welcome!</p>
            </div>
            <div className="flex gap-6 flex-wrap items-center">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 border-2 border-cream bg-transparent hover:bg-cream hover:text-black transition-all duration-200 font-bold text-sm uppercase tracking-wide"
              >
            ...
            <p className="mt-2 text-sm opacity-75">Last updated: 2025-10-14</p>
          </div>
        </div>
      </footer>
    </div>
