      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="text-[10px] uppercase tracking-wider text-black/40 mb-2">01</div>
            ...
            <div>
              <div className="text-[10px] uppercase tracking-wider text-black/40 mb-2">02</div>
            ...
            <div>
              <div className="text-[10px] uppercase tracking-wider text-black/40 mb-2">03</div>
            ...
            <div className="bg-white border-2 border-black p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between py-2 border-b border-black/10">
                  <span className="text-black/60">EchoLock servers</span>
                  <span className="font-bold">Not required</span>
                </div>
                <div className="flex justify-between py-2 border-b border-black/10">
                  <span className="text-black/60">Individual guardian</span>
                  <span className="font-bold">Cannot access alone</span>
                </div>
                <div className="flex justify-between py-2 border-b border-black/10">
                  <span className="text-black/60">Any 2 guardians colluding</span>
                  <span className="font-bold">Cannot access</span>
                </div>
                <div className="flex justify-between py-2">
                  <span className="text-black/60">Any 3 guardians</span>
