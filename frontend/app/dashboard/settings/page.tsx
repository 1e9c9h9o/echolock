    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          ...
          className="p-4 border border-black/10 hover:bg-blue transition-colors text-left"
        >
          <Download className="h-6 w-6 text-black/50 mb-2" strokeWidth={2} />
          <h4 className="font-bold text-sm">Export Data</h4>
          <p className="text-xs text-black/70 mt-1">Download encrypted backup</p>
        </button>
        <button
          onClick={() => setShowImport(true)}
          className="p-4 border border-black/10 hover:bg-blue transition-colors text-left"
        >
          <Upload className="h-6 w-6 text-black/50 mb-2" strokeWidth={2} />
          <h4 className="font-bold text-sm">Import Data</h4>
          <p className="text-xs text-black/70 mt-1">Restore from backup file</p>
        </button>
      </div>
    </div>
  )
      ...
      <div className="bg-white border border-black/10">
        <div className="p-4 border-b border-black/10">
          <h2 className="text-sm font-bold text-black/80 uppercase tracking-wider flex items-center gap-2">
            <Settings className="h-4 w-4 text-black/50" strokeWidth={2} />
            Display Preferences
          </h2>
        </div>
        <div className="p-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className={`p-4 border text-left transition-colors ${
                uiMode === 'simple'
                  ...
                  : 'border-black/10 hover:bg-blue'
              }`}
            >
              <h4 className="font-bold text-sm">Simple</h4>
              <p className={`text-xs mt-1 ${uiMode === 'simple' ? 'text-black/30' : 'text-black/70'}`}>
            ...
            >
              ...
              <p className={`text-xs mt-1 ${uiMode === 'advanced' ? 'text-black/30' : 'text-black/70'}`}>
    ...
    <div className="bg-blue min-h-screen -m-6 p-6">
      ...
      <div className="max-w-2xl mx-auto mb-6">
        <div className="bg-black text-white p-6">
          <div className="flex items-center gap-6">
            {/* Avatar */}
            <div className="w-16 h-16 bg-black/70 flex items-center justify-center text-xl font-bold">
            ...
            <div className="flex-1">
              ...
              <p className="text-black/50 font-mono text-sm flex items-center gap-2">
                <Mail className="h-4 w-4" strokeWidth={2} />
                {displayUser.email}
              </p>
              {displayUser.createdAt && (
                <p className="text-black/70 font-mono text-xs mt-1 flex items-center gap-2">
            ...
            <div className="text-right">
              ...
              <div className="text-black/70 text-xs font-mono uppercase">Switches</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto mb-6">
        <div className="bg-white border border-black/10">
          <div className="p-4 border-b border-black/10">
            <h2 className="text-sm font-bold text-black/80 uppercase tracking-wider flex items-center gap-2">
              <User className="h-4 w-4 text-black/50" strokeWidth={2} />
              Profile
            </h2>
          </div>
          <div className="p-4">
        ...
        <div className="bg-white border border-black/10">
          ...
          <div className="p-4">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className={`p-4 ${activeSwitches > 0 ? 'bg-emerald-50 border-emerald-200' : 'bg-blue border-black/10'} border`}>
                <div className="flex items-center gap-2 mb-1">
                  {activeSwitches > 0 ? (
                    <Circle className="h-3 w-3 fill-emerald-500 text-emerald-500" strokeWidth={2} />
                  ) : (
                    <Circle className="h-3 w-3 text-black/30" strokeWidth={2} />
                  )}
                  <span className={`font-bold text-sm ${activeSwitches > 0 ? 'text-emerald-700' : 'text-black/70'}`}>
                    Active
                  </span>
                </div>
                <p className={`text-xs font-mono ${activeSwitches > 0 ? 'text-emerald-600' : 'text-black/50'}`}>
      ...
      <div className="max-w-2xl mx-auto mb-6">
        <div className="bg-white border border-black/10">
          <div className="p-4 border-b border-black/10">
            <h2 className="text-sm font-bold text-black/80 uppercase tracking-wider flex items-center gap-2">
              <Key className="h-4 w-4 text-black/50" strokeWidth={2} />
              Key Management
            </h2>
          </div>
          <div className="p-4">
      ...
      <div className="max-w-2xl mx-auto mb-6">
        <div className="bg-white border border-black/10">
          <div className="p-4 border-b border-black/10">
            <h2 className="text-sm font-bold text-black/80 uppercase tracking-wider flex items-center gap-2">
              <Monitor className="h-4 w-4 text-black/50" strokeWidth={2} />
              Active Sessions
            </h2>
          </div>
          <div className="p-4">
      ...
      <div className="max-w-2xl mx-auto mb-6">
        <div className="bg-white border border-black/10">
          <div className="p-4 border-b border-black/10">
            <h2 className="text-sm font-bold text-black/80 uppercase tracking-wider flex items-center gap-2">
              <Download className="h-4 w-4 text-black/50" strokeWidth={2} />
              Data Management
            </h2>
          </div>
          <div className="p-4">
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-black/10">
          <div className="p-4 border-b border-black/10">
            <h2 className="text-sm font-bold text-black/80 uppercase tracking-wider flex items-center gap-2">
              <Lock className="h-4 w-4 text-black/50" strokeWidth={2} />
              Password
            </h2>
          </div>
          <div className="p-4">
            <form onSubmit={handlePasswordChange} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-blue border border-black/10 text-black placeholder-black/50 focus:outline-none focus:border-black/30 focus:bg-white font-mono text-sm transition-colors"
                />
              </div>
              ...
              <button
                ...
                className={`px-4 py-2 font-bold text-xs uppercase tracking-wider transition-colors ${
                  passwordLoading
                    ? 'bg-blue-light text-black/50 cursor-not-allowed'
                    : 'bg-blue-light border border-black/10 text-black/70 hover:bg-blue'
                }`}
              >
        ...
        <div className="bg-white border border-black/10">
          <div className="p-4 border-b border-black/10">
            <h2 className="text-sm font-bold text-black/80 uppercase tracking-wider flex items-center gap-2">
              <AlertTriangle className="h-4 w-4 text-black/50" strokeWidth={2} />
              Emergency Controls
            </h2>
          </div>
          <div className="p-4">
