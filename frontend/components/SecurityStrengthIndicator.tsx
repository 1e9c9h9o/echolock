...
export default function SecurityStrengthIndicator({
  ...
  if (compact) {
    return (
      <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-green border-2 border-black">
        <Shield className="h-4 w-4" strokeWidth={2} />
        <span className="font-bold text-sm">MAXIMUM SECURITY</span>
      </div>
    )
  }
    ...
    <div className="bg-white border-2 border-black p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center">
          ...
          <h4 className="text-lg font-bold">SECURITY STRENGTH</h4>
        </div>
        <div className="px-4 py-2 bg-green border-2 border-black font-bold">
          {score}/{maxScore}
        </div>
      </div>
